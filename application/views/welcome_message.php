            ...
            <div class="mb-3 d-flex justify-content-between">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item bg-primary text-light" href="<?= base_url(''); ?>">Semua Data</a>
                        </li>
                        <li><a class="dropdown-item" href="<?= base_url('bisa-dijual'); ?>">Bisa Dijual</a></li>
                        <li><a class="dropdown-item" href="<?= base_url('tidak-bisa-dijual'); ?>">Tidak Bisa Dijual</a>
                        </li>
                    </ul>
                </div>
            </div>
